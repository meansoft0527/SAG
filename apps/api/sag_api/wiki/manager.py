...
class WikiManager:
    ...
    def get_page(self, category: str, page_name: str) -> Optional[WikiPage]:
    ...
    def save_page(self, category: str, page_name: str, content: str, source_refs: Optional[List[str]] = None) -> WikiPage:
        cat_dir = self.base_dir / "wiki" / category
...
_global_wiki_manager: Optional[WikiManager] = None
